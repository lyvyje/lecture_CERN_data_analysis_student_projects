...
print(cleanstring.count('>')) #suskaiciuoja kiek seku yra stringe
...
#Kintamuju priskirimas sekoms (dynamic array):
...
#     sequence1 = "AGCT"
#     sequence2 = "AGT"
#     aligned_seq1, aligned_seq2 = needleman_wunsch(sequence1, sequence2)
